...
export default function PressPage() {
  const pressReleases = [
    ...
    },
    {
      ...
      // ✅ CHANGED: "legal mediation services" to "legal services"
      summary: "The company unveils its next-generation digital platform, featuring real-time case tracking, secure document verification, and integrated legal services.",
      link: "#"
    },
    {
      date: "June 10, 2026",
        ...
        <div className="container mx-auto max-w-4xl relative z-10 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <h1 className="text-3xl sm:text-4xl md:text-6xl font-extrabold text-slate-900 dark:text-white tracking-tight mb-4 sm:mb-6 px-2">
              Press & <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-500 via-yellow-500 to-amber-600">Media</span>
            </h1>
      ...
      <section className="py-16 sm:py-24 px-3 sm:px-4">
        <div className="container mx-auto max-w-5xl">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-10 sm:mb-16">
            ...
            <Link href="/contact" className="text-sm sm:text-base text-amber-600 dark:text-amber-400 font-semibold hover:text-amber-700 dark:hover:text-amber-300 transition-colors flex items-center gap-1.5 whitespace-nowrap">
          ...
          <div className="space-y-4 sm:space-y-6">
            {pressReleases.map((release, index) => (
              <motion.article
                ...
                className="group p-5 sm:p-8 rounded-2xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:border-amber-500/30 dark:hover:border-amber-500/30 shadow-sm hover:shadow-lg transition-all duration-300"
              >
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                  <div className="flex-1">
                    ...
                    <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-slate-900 dark:text-white mb-3 group-hover:text-amber-600 dark:group-hover:text-amber-400 transition-colors leading-tight">
                      {release.title}
                    </h3>
                  ...
                  <div className="hidden sm:flex flex-shrink-0 items-center justify-center w-12 h-12 rounded-full bg-slate-100 dark:bg-slate-700 group-hover:bg-amber-100 dark:group-hover:bg-amber-900/30 transition-colors">
                    <FileText className="h-5 w-5 text-slate-500 dark:text-slate-400 group-hover:text-amber-600 dark:group-hover:text-amber-400" />
                  </div>
                </div>
              </motion.article>
            ))}
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="p-6 sm:p-8 rounded-2xl sm:rounded-3xl bg-white dark:bg-slate-800 border border-amber-200/50 dark:border-slate-700 shadow-sm"
            >
              <div className="flex items-center gap-3 mb-6">
                <div className="p-2.5 bg-amber-100 dark:bg-amber-900/30 rounded-xl">
                  <Download className="h-5 w-5 sm:h-6 sm:w-6 text-amber-600 dark:text-amber-400" />
                </div>
              ...
              <div className="space-y-3">
                {mediaAssets.map((asset, index) => (
                  <a 
                    key={index} 
                    href="#" 
                    className="flex items-center justify-between p-3 sm:p-4 rounded-xl bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700 hover:border-amber-500/30 dark:hover:border-amber-500/30 transition-all duration-300 group"
                  >
                    ...
                    <Download className="h-4 w-4 sm:h-5 sm:w-5 text-slate-400 group-hover:text-amber-600 dark:group-hover:text-amber-400 transition-colors flex-shrink-0" />
                  </a>
                ))}
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                <div className="p-2.5 bg-yellow-100 dark:bg-yellow-900/30 rounded-xl">
                  <Building2 className="h-5 w-5 sm:h-6 sm:w-6 text-yellow-600 dark:text-yellow-400" />
                </div>
              ...
              <div className="prose prose-slate dark:prose-invert max-w-none text-sm sm:text-base text-slate-600 dark:text-slate-400 leading-relaxed">
                <p className="mb-4">
                  {/* ✅ VERIFIED: Full company name and "legal services" */}
                  <strong className="text-slate-900 dark:text-white">Homeland Recovery Services Ltd</strong> (RC 9578175) is a premier, fully licensed recovery and legal services firm headquartered in Abuja, Nigeria. 
                </p>
                <p className="mb-4">
              ...
              <div className="mt-6 pt-6 border-t border-slate-200 dark:border-slate-700">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400">
                    <CheckCircle2 className="h-4 w-4 text-amber-500 flex-shrink-0" />
                    {/* ✅ UPDATED TO EXACT FULL ADDRESS */}
                    <span>Headquarters: Suite 205 NCWS House, Area 11 Garki 2, Abuja, FCT, Nigeria</span>
                  </li>
                  <li className="flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400">
                    <CheckCircle2 className="h-4 w-4 text-amber-500 flex-shrink-0" />
      ...
      <section className="py-16 sm:py-24 px-3 sm:px-4">
        <div className="container mx-auto max-w-4xl">
          <motion.div 
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="relative p-6 sm:p-12 rounded-2xl sm:rounded-3xl bg-gradient-to-br from-amber-600 via-yellow-500 to-amber-700 text-center overflow-hidden shadow-2xl shadow-amber-500/20"
          >
            ...
            <div className="absolute bottom-0 left-0 w-48 h-48 sm:w-64 sm:h-64 bg-black/10 rounded-full blur-[60px] sm:blur-[80px] pointer-events-none" />
            
            <div className="relative z-10">
              <ShieldCheck className="h-10 w-10 sm:h-12 sm:w-12 text-white mx-auto mb-4 sm:mb-6" />
              <h2 className="text-2xl sm:text-3xl font-extrabold text-white mb-3 sm:mb-4 px-4">
                Media Inquiries
              </h2>
              <p className="text-sm sm:text-base text-white/90 mb-8 max-w-xl mx-auto px-4 leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 px-4">
                <a 
                  href="mailto:homelandrecoveryservicesltd@gmail.com?subject=Media Inquiry" 
                  className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 py-3 sm:px-8 sm:py-4 bg-white text-amber-700 font-bold rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-xl hover:bg-amber-50 text-sm sm:text-base"
                >
                ...
                <a 
                  ...
                  className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 py-3 sm:px-8 sm:py-4 bg-white/10 hover:bg-white/20 text-white font-bold rounded-xl border border-white/30 transition-all duration-300 hover:scale-105 text-sm sm:text-base"
                >
