...
export function CoreObjectives() {
  ...
  return (
    <section className="relative py-16 sm:py-24 px-3 sm:px-4 bg-white dark:bg-slate-950 transition-colors duration-300 overflow-hidden">
      ...
      <div className="absolute top-1/3 left-0 w-[400px] sm:w-[600px] h-[400px] sm:h-[600px] bg-amber-500/5 dark:bg-amber-500/10 rounded-full blur-[100px] sm:blur-[150px] pointer-events-none" />
      <div className="absolute bottom-0 right-0 w-[300px] sm:w-[500px] h-[300px] sm:h-[500px] bg-yellow-500/5 dark:bg-yellow-500/10 rounded-full blur-[80px] sm:blur-[120px] pointer-events-none" />
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        >
          {mainObjectives.map((objective, index) => (
            <motion.div
              ...
              className={`group relative rounded-2xl sm:rounded-3xl p-4 sm:p-8 ${objective.bgColor} backdrop-blur-sm border-2 ${objective.borderColor} shadow-sm hover:shadow-xl hover:shadow-amber-500/10 transition-all duration-300 overflow-hidden`}
            >
              ...
              <div className="relative z-10">
                <div className={`inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 rounded-xl sm:rounded-2xl bg-gradient-to-br ${objective.color} text-white mb-4 sm:mb-6 shadow-lg shadow-amber-500/20 group-hover:scale-110 transition-transform duration-300`}>
                  {objective.icon}
                </div>
        ...
        <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="mb-12 sm:mb-20">
          ...
          <div className="relative p-4 sm:p-6 md:p-10 rounded-2xl sm:rounded-3xl bg-slate-50/80 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 backdrop-blur-md shadow-sm">
            <div className="hidden md:block absolute top-1/2 left-16 right-16 h-0.5 bg-slate-200 dark:bg-slate-800 -translate-y-1/2 z-0" />
              ...
              {pipelineSteps.map((step, index) => (
                <motion.div key={index} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: index * 0.15 }} whileHover={{ y: -8 }} className="group flex flex-col items-center text-center">
                  <div className="relative mb-3 sm:mb-4">
                    <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-xl sm:rounded-2xl bg-white dark:bg-slate-800 border-2 border-slate-200 dark:border-slate-700 flex items-center justify-center shadow-sm group-hover:bg-gradient-to-br group-hover:from-amber-500 group-hover:to-yellow-600 group-hover:border-transparent group-hover:shadow-xl group-hover:shadow-amber-500/30 transition-all duration-300">
                  ...
                  <h4 className="text-base sm:text-lg font-bold text-slate-900 dark:text-white mb-1 sm:mb-2 group-hover:text-amber-600 dark:group-hover:text-amber-400 transition-colors">{step.title}</h4>
        ...
        <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-50px" }} transition={{ duration: 0.6, delay: 0.4 }} className="bg-white dark:bg-slate-900 backdrop-blur-md rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-10 border border-slate-200 dark:border-slate-800 shadow-sm mb-12 sm:mb-16">
          <div className="text-center mb-8 sm:mb-10">
            <div className="inline-flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 rounded-xl sm:rounded-2xl bg-gradient-to-br from-amber-500 to-yellow-600 text-white mb-3 sm:mb-4 shadow-lg shadow-amber-500/20"><Scale className="h-6 w-6 sm:h-7 sm:w-7" /></div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {legalServices.map((service, index) => (
              <motion.div key={index} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: index * 0.1, duration: 0.5 }} whileHover={{ y: -5, transition: { duration: 0.2 } }} className="group p-4 sm:p-5 rounded-xl sm:rounded-2xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 hover:border-amber-500/30 dark:hover:border-amber-500/30 hover:shadow-lg hover:shadow-amber-500/10 transition-all duration-300">
                <div className="flex items-center gap-3 mb-3">
                  <div className="p-2 rounded-lg bg-amber-100 dark:bg-amber-900/30 text-amber-600 dark:text-amber-400 group-hover:scale-110 transition-transform">{service.icon}</div>
        ...
        >
          <motion.div
            ...
            className="relative w-full max-w-4xl mx-auto p-4 sm:p-6 md:p-12 rounded-2xl sm:rounded-3xl bg-gradient-to-br from-white to-slate-50 dark:from-slate-900 dark:to-slate-800 backdrop-blur-xl border border-amber-500/20 shadow-xl shadow-amber-500/5 overflow-hidden"
          >
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6 sm:gap-8 md:gap-12">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <div className="inline-flex items-center gap-2 sm:gap-3 px-3 sm:px-5 py-2 sm:py-2.5 bg-amber-50 dark:bg-amber-900/20 rounded-lg sm:rounded-xl border border-amber-200 dark:border-amber-800 backdrop-blur-sm">
                  <ShieldCheck className="h-4 w-4 sm:h-5 sm:w-5 text-amber-600 dark:text-amber-400" />
                  <div className="flex flex-col items-start">
                    <span className="text-[8px] sm:text-[10px] font-bold text-amber-700/70 dark:text-amber-400/70 uppercase tracking-wider">RC Number</span>
