...
export function Hero() {
  ...
  const quickActions = [
    { href: "/track", label: t("Reference ID", "Reference ID"), icon: Hash, bgColor: "bg-amber-500/10", iconColor: "text-amber-600", hoverGlow: "group-hover:shadow-amber-500/20", borderColor: "group-hover:border-amber-500/30" },
    { href: "/report", label: t("Found/Report", "Find/Report"), icon: Search, bgColor: "bg-emerald-500/10", iconColor: "text-emerald-600", hoverGlow: "group-hover:shadow-emerald-500/20", borderColor: "group-hover:border-emerald-500/30" },
    { href: "/complaints", label: t("Lost/Complaint", "Lost/Complain"), icon: AlertCircle, bgColor: "bg-orange-500/10", iconColor: "text-orange-600", hoverGlow: "group-hover:shadow-orange-500/20", borderColor: "group-hover:border-orange-500/30" },
    { href: "/flagged", label: t("Flagged Items", "Flagged Items"), icon: Flag, bgColor: "bg-red-500/10", iconColor: "text-red-600", hoverGlow: "group-hover:shadow-red-500/20", borderColor: "group-hover:border-red-500/30" },
    { href: "/legal-services", label: t("Legal Services", "Legal Services"), icon: Scale, bgColor: "bg-purple-500/10", iconColor: "text-purple-600", hoverGlow: "group-hover:shadow-purple-500/20", borderColor: "group-hover:border-purple-500/30" },
    { href: "/contact", label: t("Contact", "Contact Us"), icon: Phone, bgColor: "bg-slate-500/10", iconColor: "text-slate-600", hoverGlow: "group-hover:shadow-slate-500/20", borderColor: "group-hover:border-slate-500/30" },
  ];
